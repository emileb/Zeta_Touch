...
public class SwLauncher extends RazeBaseLauncher
{
    ...
    public void updateSubGames(GameEngine engine, ArrayList<SubGame> availableSubGames)
    {
        ...
        SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + ".", ".", RAZE_GAME_SW, WEAPON_WHEEL_NBR, new String[]{"sw.grp"}, R.drawable.sw, "Shadow Warrior",
                        "Copy SW.GRP to:", "Put your SW.GRP files here.txt");

        SubGame sg = SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + "addons/td", "addons/td", RAZE_GAME_SW, WEAPON_WHEEL_NBR, new String[]{"addons/td/td.grp"},
        ...
        sg = SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + "addons/wt", "addons/wt", RAZE_GAME_SW, WEAPON_WHEEL_NBR, new String[]{"addons/wt/wt.grp"}, R.drawable.raze,
