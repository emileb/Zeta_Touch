...
public class DukeLauncher extends RazeBaseLauncher
{
    ...
    public void updateSubGames(GameEngine engine, ArrayList<SubGame> availableSubGames)
    {
        ...
        SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + ".", ".", RAZE_GAME_DUKE, WEAPON_WHEEL_NBR, new String[]{"duke3d.grp"}, R.drawable.dn3d, "Duke Nukem 3D",
                        "Copy duke3d.grp to:", "Put your Duke 3D files here.txt");

        SubGame sg = SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + "addons/nw", "addons/nw", RAZE_GAME_DUKE, WEAPON_WHEEL_NBR, new String[]{"addons/nw/nwinter.grp"},
        ...
        sg = SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + "addons/vacation", "addons/vacation", RAZE_GAME_DUKE, WEAPON_WHEEL_NBR, new String[]{"addons/vacation/vacation.grp"},
        ...
        sg = SubGame.addGame(availableSubGames, getRunDirectory(), getSecondaryDirectory(), SUB_DIR + "addons/dc", "addons/dc", RAZE_GAME_DUKE, WEAPON_WHEEL_NBR, new String[]{"addons/dc/dukedc.grp"},
